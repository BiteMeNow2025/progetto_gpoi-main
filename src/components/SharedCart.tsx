  ...
  const [orders, setOrders] = useState<Order[]>([
    {
      ...
      items: [
        { name: 'Panino Caprese', price: 4.50, quantity: 1 },
        { name: 'Acqua Naturale', price: 1.00, quantity: 1 }
      ],
      total: 5.50,
      paymentStatus: 'paid',
    ...
    },
    {
      ...
      items: [
        { name: 'Pizza Margherita', price: 5.00, quantity: 1 },
